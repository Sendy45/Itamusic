...
public class NoteTestActivity extends AppCompatActivity {
    ...
    private final String activityDailyMission = "Do 10 notes questions";
    private Note note;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Play the note again
        btnRelisten.setOnClickListener(v -> note.play(1000));
    ...
    public void nextQuestion() {
        ...
        note = piano.getNotesList().get(r.nextInt(11));
        ArrayList<String> noteNameList = piano.getNotesNamesList();

        answerList.add(note.getName()); // Add the correct answer
        ...
        textViewAnswerList.get(0).setText(note.getName());
        ...
        new Handler().postDelayed(() -> {
            // Play note and check for answer
            note.play(1000);
        ...
        for (ImageButton button : ButtonAnswerList) {
            ...
            button.setOnClickListener(view -> {
                ...
                if (isCorrectAnswer) { // Success
                    ...
                    stats.incrementNotesQuestions(true);
                } else { // Failure
                    stats.incrementNotesQuestions(false);
                }
